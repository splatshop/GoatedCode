...
, {
  defaultMessage: "This project uses cloud variables. GoatedCode uses its own cloud variable server independent of Scratch. Beware of impersonation as anyone can change their username to anything. {learnMore}",
...
const PACKAGER_URL = 'https://GoatedCode.github.io/GoatedCode-Packager';
const PACKAGER_ORIGIN = "https://GoatedCode.github.io";
...
if (window.parent !== window) {
  ...
  alert('This page is embedding GoatedCode/TurboWarp in a way that is unsupported and will cease to function in the near future. Please read https://docs.turbowarp.org/embedding');
...
// eslint-disable-next-line max-len
, {
  defaultMessage: "GoatedCode and TurboWarp are not affiliated with Scratch, the Scratch Team, or the Scratch Foundation.",
...
class Interface extends react__WEBPACK_IMPORTED_MODULE_2___default.a.Component {
  ...
  handleUpdateProjectTitle(title, isDefault) {
    if (isDefault || !title) {
      document.title = "GoatedCode - ".concat(this.props.intl.formatMessage(messages.defaultTitle));
    } else {
      document.title = "".concat(title, " - GoatedCode");
    }
  }
  render() {
    const _this$props = this.props,
    ...
    // eslint-disable-next-line max-len
    , {
      defaultMessage: "GoatedCode is a mod of TurboWarp to add new blocks and features. TurboWarp is a Scratch mod that compiles projects to JavaScript to make them run really fast. Try it out by inputting a project ID or URL above or choosing a featured project below.",
